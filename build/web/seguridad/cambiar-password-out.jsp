...
<s:form id="form_pass" action="cambiarPasswordOutClie" theme="simple">
        <div class="input-group mb-3">
            <s:password name="cliente.password" id="password2" cssClass="form-control" placeholder="Nueva Contraseña" required="required"/>
        ...
        <div class="input-group mb-3">
            <input type="password" name="password3" id="password3" class="form-control" placeholder="Confirmar Contraseña" required="required">
          <div class="input-group-append">
